...
<h1 class="text-center text-info mt-4 pt-4">EDIT EXPENSE</h1>
<c:url value="updateExpense" var="action" />
...
<form:form method="post" action="${action}" modelAttribute="expense">
    ...
    <div class="form-group row">
        ...
        <div class="col">
            ...
            <form:input path="date" id="startDate" class="form-control" type="date"/>
