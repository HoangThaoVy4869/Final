<%-- 
    Document   : addExpenseTeam
    Created on : Aug 29, 2022, 10:13:18 PM
    Author     : USER
--%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<h1 class="text-center text-info mt-4 pt-4">ADD NEW EXPENSE TEAM</h1>

<c:url value="/user/addExpenseTeam" var="action"/>
...
<div class="col-1">
    <a href="<c:url value="/home"/>"><button class="btn btn-warning">Back</button></a>
</div>