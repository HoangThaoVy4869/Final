<%-- 
    Document   : expenseTeamList
    Created on : Aug 29, 2022, 12:30:54 AM
    Author     : USER
--%>
...
<body>
    <div class="container pt-4 mt-3">
        ...
        <div class="form-group row">
            <div class="col">
                <a href="<c:url value="/user/addExpenseTeam"/>"><button type="submit" class="btn btn-primary">Add new</button></a>
            </div>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <c:forEach items="${expenseTeam}" var="et">
                    <tr>
                        <td class="col-2">${et[0]}</td>
                        <td class="col-3">${et[1]} VNĐ</td>
                        <td class="col-2">${et[2]}</td>
                        <td class="col-2">${et[3]}</td>
                        <td class="col-2">
                            <a href="<c:url value="/user/editExpenseTeam/${et[4]}"/>"><button class="btn btn-light">Edit</button></a>
                            <a href="<c:url value="/user/deleteExpenseTeam/${et[4]}"/>"><button class="btn btn-danger">Delete</button></a>
                            <a href="<c:url value="/user/detailsExpenseTeam/${et[4]}"/>"><button class="btn btn-warning">Details</button></a>
                        </td>
                    </tr>
                </c:forEach>       
            </tbody>
